...
# Generation Time: 2017-03-06 14:32:01 +0000
# ************************************************************
...
INSERT INTO `Session` (`sessionId`, `type`, `sessionDate`, `startTime`, `endTime`, `assignedInstructor`, `maxUsers`)
VALUES
	(1,1,'2017-03-07','10:00:00','11:00:00',NULL,100),
	(2,2,'2017-03-07','11:00:00','12:00:00',NULL,50),
	(3,3,'2017-03-08','10:00:00','11:00:00',000000,6),
	(4,1,'2017-03-08','15:00:00','17:00:00',NULL,100),
	(5,2,'2017-03-09','09:00:00','10:00:00',NULL,50),
	(6,2,'2017-03-09','11:00:00','12:00:00',NULL,50),
	(7,1,'2017-03-10','09:00:00','17:00:00',NULL,100),
	(8,1,'2017-03-11','09:00:00','14:00:00',NULL,100);
...
LOCK TABLES `Session-Customer` WRITE;
/*!40000 ALTER TABLE `Session-Customer` DISABLE KEYS */;

INSERT INTO `Session-Customer` (`customerId`, `sessionId`)
VALUES
	(2,1),
	(2,2),
	(2,3),
...
/*!40000 ALTER TABLE `Session-Customer` ENABLE KEYS */;
UNLOCK TABLES;
